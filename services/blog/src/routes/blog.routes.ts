...
import { addComment, deleteComment, getAllBlogs, getAllComments, getBlogById, getSavedBlog, saveBlog, unsaveBlog } from '../controllers/blog.controller.js';
...
router.delete("/unsave/:blogid", isAuth, unsaveBlog);
